package com.cashapona.Datatypes.Jun2;
	...
	public class CashaponaDatatypes {
		/**
		 * @param args
		 */
		public static void main(String[] args){
			System.out.println("-----------------------Employee details-------------------");
			Cashapona emp1=new Cashapona("A101","venkat","Software TRainee",39,12000);
			...
			Cashapona emp4=new Cashapona("T104","Anuradha","Software TRainee",24,160000);
